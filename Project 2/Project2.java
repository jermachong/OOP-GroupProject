...
public class Main {
    public static void main(String[] args) {
        ...
        char selection; // character to for menu input
        ...
        do {
            ...
            if (selection == '1') {// entering faculty info
                ...
                do {
                    ...
                    try {
                        ...
                        } else if (Student.findPerson(personArr, newID) != null)// check to make sure ID is not already
                                                                                // in the personArr
                        {
                            ...
                            for (int i = 0; i < 6; i++) {
                                ...
                                if (i > 2 && newID.charAt(i) < 48 || i > 2 && newID.charAt(i) > 57)// checks to make
                                                                                                   ...
                                                                                                   // digits
                                    throw new idException(
                                            "ID isnot formatted correctly. ID format should be [letter letter digit digit digit digit]");
                            }
                            break;
                        } else
                ...
                do {
                    ...
                    if (newRank.equalsIgnoreCase("professor") || newRank.equalsIgnoreCase("adjunct")) {
                        // input was valid, format rank, break out of the do while loop and move onto
                ...
                do {
                    ...
                    if (newDepartment.equalsIgnoreCase("mathematics") || newDepartment.equalsIgnoreCase("sciences")
                            || newDepartment.equalsIgnoreCase("engineering")) {
                        // input was valid. format newDepartment and break the do while
                        newDepartment = newDepartment.substring(0, 1).toUpperCase()
                                + newDepartment.substring(1).toLowerCase();
                        break;
                    } else {
                ...
                Faculty f = new Faculty(newName, newID, newDepartment, newRank); // Create Faculty with given info
            ...
            // Print tuition invoice for a student
                ...
                {
                    if (Student.findPerson(personArr, inputID) instanceof Student) {// makes sure person found is a
                                                                                    // student
                        System.out.println("\tHere is the tuition invoice for "
                                + Student.findPerson(personArr, inputID).getFullName());
                        System.out.println(Student.findPerson(personArr, inputID).print());
                    } else
                        System.out.println(inputID + " is not a student! Please select a different option.");// if input
                                                                                                             // is not a
                                                                                                             // student,
                                                                                                             // do not
                                                                                                             // print
            ...
            // print faculty info
                ...
                if (Person.findPerson(personArr, inputID) != null)// check if the id entered is found in the personArr
                                                                  // list
                {
                    if (Person.findPerson(personArr, inputID) instanceof Faculty)// check if person found is Faculty
                    {
                        System.out.print("\n");
                        System.out.println(Person.findPerson(personArr, inputID).print());// if person is in list and
                                                                                          // faculty, print infor
                    } else
                        System.out.println(inputID + " is not a member of Faculty! Please select a different option.");// display
                                                                                                                       // statement
                                                                                                                       // if
                                                                                                                       // not
                                                                                                                       // faculty
...
try{
                ...
                do {
                    ...
                    if (newDepartment.equalsIgnoreCase("mathematics") || newDepartment.equalsIgnoreCase("sciences")
                            || newDepartment.equalsIgnoreCase("engineering")) {
                        // if newDepartment is a valid subject, format newDepartment and exit the do
                        // while
                        newDepartment = newDepartment.substring(0, 1).toUpperCase()
                                + newDepartment.substring(1).toLowerCase();
                        break;
                    } else {
                        System.out.println("\t" + newDepartment + " is invalid"); // display if newDepartnent is not
                                                                                  // valid
                ...
                do {
                    ...
                    if (newStatus.equalsIgnoreCase("f") || newStatus.equalsIgnoreCase("p")) {// check if newStatus is
                                                                                             // one of the 2 valid
                                                                                             // options
                        ...
                        System.out.println(newStatus + "is invalid, enter a valid Status");// display statement if
                                                                                           // newStatus is not 'p' or
                                                                                           // 'f'
                        continue;
                    }
                } while (true);
            ...
            // Print Staff Information
                ...
                {
                    if (Person.findPerson(personArr, inputID) instanceof Staff)// checks if the person found is a member
                                                                               // of Staff
                    {
                        ...
                        System.out.println(inputID + " is not a member of Staff! Please select a different option.");// display
                                                                                                                     // if
                                                                                                                     // found
                                                                                                                     // Person
                                                                                                                     // is
...
abstract class Person {
    ...
    public void validateId() throws idException {
        ...
        for (int i = 0; i < 6; i++) {
            if (i < 2 && id.charAt(i) < 97 || id.charAt(i) > 122)// checks to make sure first two characters are
                                                                 // lowercase letters
                throw new idException(
                        "ID is not formatted correctly. ID format should be [letter letter digit digit digit digit]");

            else if (i >= 2 && id.charAt(i) < 48 || id.charAt(i) > 57)// checks to make sure remaining characters are
                                                                      // digits
                throw new idException(
                        "ID is not formatted correctly. ID format should be [letter letter digit digit digit digit]");
        }
